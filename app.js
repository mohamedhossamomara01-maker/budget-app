...
function SalaryModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: { fontSize: 10, color: "#4a6080", marginTop: 6, display: "flex", justifyContent: "space-between", alignItems: "center" }
  }, /*#__PURE__*/React.createElement("span", null, "متبقي ضحي من الشهر اللي فات ", fmt(carry.prevDuhaBalance), " ج"), /*#__PURE__*/React.createElement("button", {
    onClick: () => sf(p => ({ ...p, home_given: (+(p.home_given) || 10000) + carry.prevDuhaBalance })),
    style: { background: "none", border: "none", color: T.purple, fontSize: 10, fontWeight: 700, cursor: "pointer", fontFamily: "'Cairo',sans-serif" }
  }, "🔄 ضيفه للمرتب"))), /*#__PURE__*/React.createElement("div", {
    style: {
...
function CategoryScreen({
  ...
  const budget = saved[budgetKey] ? +saved[budgetKey] : (defaultBudget + (budgetExtra || 0));
...
function SummaryScreen({
  ...
  }, "👩 + متبقي ضحي ", fmt(prevDuhaBalance), " ج (اتضاف لمرتبها تلقائي، مش هنا)"), n("deals") > 0 && /*#__PURE__*/React.createElement(R, {
    icon: "🤝",
    lbl: "صفقات",
    val: n("deals"),
    c: T.green
