...
async function geminiAnalyze(parts) {
...
// تحليل صورة من base64 مباشرة (مش من URL)
async function analyzeBodyPhoto(base64Data, mimeType) {
  return geminiAnalyze([
    { text: "أنت مساعد لياقة بدنية. حلل هذه الصورة وأعطني ملاحظات عن الجسم مثل: الوجه، منطقة البطن، الجسم عموماً. كن إيجابياً ومشجعاً. الرد بالعربية فقط في 3-4 جمل قصيرة." },
