...
function SummaryScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    const mAllH = [...HOME_DATA.filter(e => !dxl.includes(e.id)), ...entries.filter(e => e.type === "home")].filter(e => finKey(e.date) === monthKey);
