...
const ld = (k, d) => {
  try {
    const v = _store[k];
    return v !== undefined ? JSON.parse(v) : d;
  } catch {
    return d;
  }
};
...
function CategoryScreen({
  ...
  const shownEntries = filterDate ? month.filter(e => e.date === filterDate) : month;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tabs, {
    tabs: [["today", "النهارده"], ["add", "➕ أضف"], ["month", "الشهر"]],
    cur: view,
    set: sv2
  }), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: S.btn(),
    onClick: doAdd
  }, "إضافة ✓")), view === "month" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: S.sub
  }, "حسب التصنيف"), bycat.map(c => /*#__PURE__*/React.createElement("div", {
    key: c.id,
    style: {
      marginBottom: 9
    }
  ...
  }, c.ic, " ", c.l), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 5,
      alignItems: "center"
  ...
  }, fmt(c.total), " ج"))))), /*#__PURE__*/React.createElement("div", {
    style: S.div
  }), /*#__PURE__*/React.createElement("div", {
    style: {display:"flex",alignItems:"center",gap:6,marginBottom:6}
  }, /*#__PURE__*/React.createElement("span", {
    style: {...S.sub, margin:0, flex:1}
  }, filterDate ? fmt(shownTot) + " ج (" + shownEntries.length + ")" : "كل المصاريف (" + month.length + ")"), /*#__PURE__*/React.createElement("input", {
    type: "date", value: filterDate,
    onChange: e => setFD(e.target.value),
    style: {background:T.card, border:`1px solid ${filterDate ? T.blue : T.bdr}`, borderRadius:6, color: filterDate ? T.blue : "#4a6080", fontSize:11, padding:"3px 6px", fontFamily:"'Cairo',sans-serif"}
  }), filterDate && /*#__PURE__*/React.createElement("button", {
    onClick: () => setFD(""),
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: e.id,
      style: {display:"flex", justifyContent:"space-between", padding:"8px 0", borderBottom:`1px solid ${T.bdr}`}
    }, /*#__PURE__*/React.createElement("div", {
      style: {display:"flex", gap:7}
    }, /*#__PURE__*/React.createElement("span", {style:{fontSize:16}}, c.ic), /*#__PURE__*/React.createElement("div", null,
      /*#__PURE__*/React.createElement("div", {style:{fontSize:11,fontWeight:700}}, e.name || c.l),
      /*#__PURE__*/React.createElement("div", {style:{fontSize:10,color:"#4a6080"}}, e.date)
    )), /*#__PURE__*/React.createElement("div", {
      style: {display:"flex", gap:7, alignItems:"center"}
    }, /*#__PURE__*/React.createElement("span", {style:{fontSize:11,fontWeight:700,color:c.c}}, fmt(e.amount), " ج"),
...
function SummaryScreen({
  ...
  const totalOut = fix + duhaAllowance + mHomeTot + mCar + (duhaWSal||0) + (duhaWSav||0);
  // إندرايف للشهر: الأوردرات بتزود "إجمالي الدخل" مباشرة،
  // والبنزين/الضريبة/النفخ بتتخصم بس من "الصافي النهائي" (balance) ومش بتأثر على رقم الدخل
  ...
  const balance = inc - totalOut - indExpenses;
  ...
  }, [["الثوابت", fixDisplay || 9480, T.red], ["أكل وبيت", mHomeTot, T.blue], ["صيانة", mCar, "#a78bfa"]].map(([l, v, c]) => /*#__PURE__*/React.createElement("div", {
    key: l,
    style: {
      textAlign: "center"
    }
...
function IndriveScreen({
  ...
  }, "المبلغ (ج)"), /*#__PURE__*/React.createElement("input", {
    style: S.inp,
    type: "number",
  ...
  }, grandOrders, " أوردر"))), months.map(m => {
    const d = summary[m];
...
function GoalsScreen({
  ...
  const [ch, sCh] = useState(() => ld("mh_ch5", CHECK_DEF.map((t, i) => ({
    id: i,
    t,
    done: false
  }))));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: S.sub
  }, "محاسبة النفس اليومية ✅"), /*#__PURE__*/React.createElement("div", {
    style: S.card()
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...S.row,
...
function App() {
  ...
  }), tab === "duha" && /*#__PURE__*/React.createElement(CategoryScreen, {
    entries: entries,
    onAdd: addE,
    onDel: delE,
    mk: mk,
