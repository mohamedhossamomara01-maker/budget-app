...
function SalaryModal({
  ...
  }, /*#__PURE__*/React.createElement("span", null, "متبقي محمد ", fmt(carry.prevBalance), " + متبقي ضحي ", fmt(carry.prevDuhaBalance), " = ", fmt(carry.combined), " ج"), /*#__PURE__*/React.createElement("button", {
...
function CarScreen({
  ...
  const [lastOilKm, setLastOilKm] = useState(() => ld("car_last_oil_km_v2", 0));
  useEffect(() => sv("car_last_oil_km_v2", lastOilKm), [lastOilKm]);
  const [curOdo, setCurOdo] = useState(() => ld("car_odo_v1", 0));
  useEffect(() => sv("car_odo_v1", curOdo), [curOdo]);
  const nextOilKm = lastOilKm > 0 ? lastOilKm + OIL_INTERVAL : null;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tabs, {
  ...
  }, "🛢️ ميعاد تغيير الزيت الجاي"), lastOilKm > 0 && /*#__PURE__*/React.createElement("div", {
    style: { fontSize: 11, color: "#4a6080", marginBottom: 7 }
  }, "الهدف عند ", fmt(nextOilKm), " كم (كل ", fmt(OIL_INTERVAL), " كم)"), /*#__PURE__*/React.createElement("div", {
    style: { display: "flex", gap: 7, marginBottom: 8 }
  }, /*#__PURE__*/React.createElement("div", {
    style: { flex: 1 }
  }, /*#__PURE__*/React.createElement("div", {
    style: { fontSize: 10, color: "#4a6080", marginBottom: 4 }
  }, "آخر تغيير زيت عند (كم)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    inputMode: "numeric",
    placeholder: "مثلاً 226130",
    value: lastOilKm || "",
    onChange: e => setLastOilKm(parseFloat(e.target.value) || 0),
    style: { ...S.inp, marginBottom: 0 }
  })), /*#__PURE__*/React.createElement("div", {
    style: { flex: 1 }
  }, /*#__PURE__*/React.createElement("div", {
    style: { fontSize: 10, color: "#4a6080", marginBottom: 4 }
  }, "عداد العربية دلوقتي"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    inputMode: "numeric",
    placeholder: "مثلاً 226900",
    value: curOdo || "",
    ...
    v: Math.min(curOdo - lastOilKm, OIL_INTERVAL),
    max: OIL_INTERVAL,
    ...
    }, e.date, e.km ? ` · ${e.km} كم` : "", e.note ? ` · ${e.note}` : "", e.paidBy === "doha" ? " · 👩 مرتب ضحي" : e.paidBy === "tahwish" ? " · 💰 من التحويش" : ""))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 7,
        alignItems: "center"
...
function SummaryScreen({
  ...
  }, fmt(mDuhaTot), " ج")))), (mCar + mCarDoha + mCarTahwish) > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: S.sub
