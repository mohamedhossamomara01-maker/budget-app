...
function CategoryScreen({
  ...
  // المتبقي بيتخصم بس من اللي اتدفع فعلاً من مرتب صاحب التاب ده — أي حاجة متسجلة "من مرتب التاني" أو "من التحويش" مبتخصمش من هنا
  const mTotOwn = SUM(month.filter(e => !e.paidBy || e.paidBy === ownPayer));
